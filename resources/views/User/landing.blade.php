...
@section('title', 'PEWA- Pengaduan Warga')
...
<section class="header">
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">PEWA</h4>
                    <p class="italic mt-0 text-white">Pengaduan Warga</p>
                </a>
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Layanan Pengaduan Warga</h2>
        <p class="italic text-white mb-5">Sampaikan laporan Langsung di sini</p>
    </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2022 Tohari • All rights reserved</p>
    </div>
</div>
{{-- Modal --}}
